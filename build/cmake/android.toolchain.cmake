...
elseif(ANDROID_ABI STREQUAL mips32r6)
  set(ANDROID_SYSROOT_ABI mips)
  set(CMAKE_SYSTEM_PROCESSOR mips)
  set(ANDROID_TOOLCHAIN_NAME mips64el-linux-android)
  set(ANDROID_TOOLCHAIN_ROOT ${ANDROID_TOOLCHAIN_NAME})
...
if(ANDROID_ABI STREQUAL mips32r6)
	# Help clang find support binaries (as, ld ...) on mips32r6
	list(APPEND ANDROID_COMPILER_FLAGS
		-mips32r6 -mno-odd-spreg -B${ANDROID_TOOLCHAIN_ROOT}/bin/mips64el-linux-android-)
endif()
if(ANDROID_ABI STREQUAL mips32r6 AND ANDROID_TOOLCHAIN STREQUAL clang)
	# Help clang use mips64el multilib GCC
	list(APPEND ANDROID_LINKER_FLAGS
		-L${ANDROID_TOOLCHAIN_ROOT}/lib/gcc/${ANDROID_TOOLCHAIN_NAME}/4.9.x/32/mips-r6 -B${ANDROID_NDK}/platforms/${ANDROID_PLATFORM}/arch-${ANDROID_SYSROOT_ABI}/usr/libr6 -L${ANDROID_NDK}/platforms/${ANDROID_PLATFORM}/arch-${ANDROID_SYSROOT_ABI}/usr/libr6)
endif()
