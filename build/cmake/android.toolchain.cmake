...
if(ANDROID_ABI STREQUAL mips32r6)
	...
	list(APPEND ANDROID_COMPILER_FLAGS
		-mips32r6 -B${ANDROID_TOOLCHAIN_ROOT}/bin/mipsel-linux-android-)
endif()
if(ANDROID_ABI STREQUAL mips32r6 AND ANDROID_TOOLCHAIN STREQUAL clang)
	# Help clang use mipsel multilib GCC
	list(APPEND ANDROID_LINKER_FLAGS
		-L${ANDROID_TOOLCHAIN_ROOT}/lib/gcc/${ANDROID_TOOLCHAIN_NAME}/4.9.x/mips-r6 -B${ANDROID_NDK}/platforms/${ANDROID_PLATFORM}/arch-${ANDROID_SYSROOT_ABI}/usr/libr6 -L${ANDROID_NDK}/platforms/${ANDROID_PLATFORM}/arch-${ANDROID_SYSROOT_ABI}/usr/libr6)
endif()
# STL specific flags.
if(ANDROID_STL STREQUAL system)
