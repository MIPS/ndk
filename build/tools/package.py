...
def get_all_packages(host, arches):
    packages = [
        ...
        ('renderscript-toolchain-{host}',
            'toolchains/renderscript/prebuilt/{host}'),
